...
![](/images/articles/d010c4a3110a90/2bbfee495d8f-20211117.png)

## 2,Calendarを選択してIDをコピーする
画面の左側にあるメニューから、操作対象のCalendarを選択し、
右側(下にスクロールしましょう)の"Integrate Calendar"にあるIDをコピーします。

![](/images/articles/d010c4a3110a90/984237e69d6d-20211117.png)
...
![](/images/articles/d010c4a3110a90/3c05de5eee34-20211118.png)

次に、"Apps Script"をクリックして"ScriptEditor"を立ち上げます。

![](/images/articles/d010c4a3110a90/d4193aa8be45-20211118.png)

次の様な画面が"ScriptEditor"と呼ばれる物です。

![](/images/articles/d010c4a3110a90/bc6d1d430dcb-20211118.png)
...
![](/images/articles/d010c4a3110a90/b066a9befa65-20211117.png)
...
![](/images/articles/d010c4a3110a90/a2b8a3bf2da3-20211117.png)

## 3-2, ユーザーを選択する
スクリプトを実行するユーザーを選択します。

![](/images/articles/d010c4a3110a90/c3f79f3cf49b-20211117.png)

## 3-3, 実行許可を与える
"Show Advanced"をクリックし、"Go to Untitled project(unsafe)"をクリックします。

![](/images/articles/d010c4a3110a90/317b909c2d92-20211117.png)

## 3-4, 許可ボタンを押す
最後に"Allow"ボタンを押します。

![](/images/articles/d010c4a3110a90/56dbdd3c2738-20211117.png)

実行が成功すると、"Executing log"の画面に実行結果として、カレンダー名が表示されます。(やりました!!)

![](/images/articles/d010c4a3110a90/2665581d4f7d-20211117.png)
...
![](/images/articles/d010c4a3110a90/cba194f24cd1-20211117.png)
...
![](/images/articles/d010c4a3110a90/d42c47186d94-20211117.png)
...
![](/images/articles/d010c4a3110a90/39283ad64d4e-20211117.png)
...
![](/images/articles/d010c4a3110a90/4c49559d26328bee8de5d046.png)

## Deployする
"Deploy" -> "New deployment"の順にクリックします。

![](/images/articles/d010c4a3110a90/d7710fc0ce4e44be7b7f16d8.png)

## Deployment typeを選択する
"歯車ボタン" -> "Web App"の順にクリックします。

![](/images/articles/d010c4a3110a90/381e323025dce9cf0bdf616e.png)

## アクセス権限を選択する
"Who has access"で、"Anyone"を選択し"Deploy"をクリックします。

![](/images/articles/d010c4a3110a90/71c21d7a278074f2da903707.png)

## アクセス先のURLを取得する
アクセス先のURLが表示されるので、"Copy"をクリックします。

![](/images/articles/d010c4a3110a90/7decc78e494168de1bbb4e5d.png)

## ブラウザからURLへアクセスする
コピーしたURLをブラウザに入力してアクセスすると、"doGet"関数のreturn値で生成した文字列(JSON)がブラウザに表示されます。(やりました!!)

![](/images/articles/d010c4a3110a90/83cd80944828320c6e022d5e.png)
...
![](/images/articles/d010c4a3110a90/1d77c324392d-20211119.png)
...
![](/images/articles/d010c4a3110a90/ad82cba37f58-20211118.png)
...
![](/images/articles/d010c4a3110a90/523154e158c2-20211118.png)
...
![](/images/articles/d010c4a3110a90/5edeed0be540-20211118.png)
...
![](/images/articles/d010c4a3110a90/1fa1d9839550-20211118.png)
