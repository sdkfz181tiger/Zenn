...
Python3エンジニア認定[基礎試験](https://www.pythonic-exam.com/exam/basic)、[実践試験](https://www.pythonic-exam.com/exam/jissen)の受験対策で学習したサンプルコードをまとめます。
