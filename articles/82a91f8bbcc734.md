...
![](/images/articles/82a91f8bbcc734/a2a6681be4c462ca5e33110b.png)

## スプレッドシートを用意する
画面の右下にある"+"ボタンを押してスプレッドシートを用意します。

![](/images/articles/82a91f8bbcc734/6ce1d77a36bc5dfbb7285447.png)

## 仮のデータを用意する
スプレッドシートに仮のデータを入力します。
1行目は、明示的にデータの種類(カラム)を記述しておきましょう。

![](/images/articles/82a91f8bbcc734/21dc225a8ad91dc690203d53.png)
...
![](/images/articles/82a91f8bbcc734/b4da105417f6b3455c11e8ee.png)

## ScriptEditorを操作する
初期状態では、"myFunction"関数が一つ用意されています。

![](/images/articles/82a91f8bbcc734/0e815adae7a83c56585b8b6e.png)
...
![](/images/articles/82a91f8bbcc734/c79d84becd7357370f91ff43.png)
...
![](/images/articles/82a91f8bbcc734/4c49559d26328bee8de5d046.png)

## Deployする
"Deploy" -> "New deployment"の順にクリックします。

![](/images/articles/82a91f8bbcc734/d7710fc0ce4e44be7b7f16d8.png)

## Deployment typeを選択する
"歯車ボタン" -> "Web App"の順にクリックします。

![](/images/articles/82a91f8bbcc734/381e323025dce9cf0bdf616e.png)

## アクセス権限を選択する
"Who has access"で、"Anyone"を選択し"Deploy"をクリックします。

![](/images/articles/82a91f8bbcc734/71c21d7a278074f2da903707.png)

## アクセス先のURLを取得する
アクセス先のURLが表示されるので、"Copy"をクリックします。

![](/images/articles/82a91f8bbcc734/7decc78e494168de1bbb4e5d.png)

## ブラウザからURLへアクセスする
コピーしたURLをブラウザに入力してアクセスすると、"doGet"関数のreturn値で生成した文字列(JSON)がブラウザに表示されます。(やりました!!)

![](/images/articles/82a91f8bbcc734/83cd80944828320c6e022d5e.png)
...
![](/images/articles/82a91f8bbcc734/c912ac3d094c1bcce86552cf.png)

## アカウントを選択する
コードの実行者であるアカウントを選択します。
(パーミッションについては自己責任の範囲で行ってください)

![](/images/articles/82a91f8bbcc734/da1a740014a8c76824b1218a.png)

"Advanced"をクリックします。

![](/images/articles/82a91f8bbcc734/62faa615d8a2feaa59bd83e4.png)

"Go to untitled project(unsafe)"をクリックします。

![](/images/articles/82a91f8bbcc734/add0529e14e53536ed2205a0.png)

"Allow"ボタンをクリックします。

![](/images/articles/82a91f8bbcc734/f76ef83fd87e80ff78e0e83d.png)
...
![](/images/articles/82a91f8bbcc734/f9c3303a33bf51b80b4bb509.png)
