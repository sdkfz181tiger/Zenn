---
title: "第13章(付録1): 実行してみよう(IDLE編)"
---

# 実行してみよう(IDLE編)

ここでは、Pythonのインストールと、IDLEを使った開発環境の構築手順を紹介します。
...
"untitled"というウィンドウが開きます。(この時点ではまだ保存はしていません)
この画面に次のコードを入力します。
