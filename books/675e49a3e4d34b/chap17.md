---
title: "第17章(サンプル): ドットを食べて追いかけっこするやつ"
---
...
class Game:
    ...
    def create_dot(self, x, y, power_flg):
        dot = DotSprite(0, 0, 0, 16, power_flg)
        dot.set_center(x, y)
...
完成コード(オンラインエディタ版): [PyxelCodeMaker](https://kitao.github.io/pyxel/web/code-maker/?github=sdkfz181tiger/Zenn/main/images/books/675e49a3e4d34b/pce/shooter_samples/chap17_comp)

[完成したリソースファイルをダウンロード](https://github.com/sdkfz181tiger/Zenn/blob/main/images/books/675e49a3e4d34b/pce/shooter_samples/chap17_comp.zip) (右上の"ダウンロード"ボタンを押してダウンロードしてください)
