---
title: "第20章(サンプル): 空を飛んでコインとるやつ"
---

# 空を飛んでコインとるやつ(サンプル)

今回は、どこかで見た様な飛んでコイン取るゲームに挑戦します。
(ここでは、サンプルコードのみの紹介です)
...
![](/images/books/675e49a3e4d34b/20_01.png)
...
完成コード(オンラインエディタ版): [PyxelCodeMaker](https://kitao.github.io/pyxel/web/code-maker/?github=sdkfz181tiger/Zenn/main/images/books/675e49a3e4d34b/pce/shooter_samples/chap20_comp)

[完成したリソースファイルをダウンロード](https://github.com/sdkfz181tiger/Zenn/blob/main/images/books/675e49a3e4d34b/pce/shooter_samples/chap20_comp.zip) (右上の"ダウンロード"ボタンを押してダウンロードしてください)
