...
散らばったコインを集める、シンプルで(ちょっと可愛い)ゲームです。

"プログラミングでゲームが動くってこういうことか!!"
そんな体験を味わってもらえる内容です。

![](/images/28713ff37533c0/01_01.gif)

# 番外編について(順次追加中!!)

その他、番外編では、以下のサンプルコードも紹介しています。
基本的な動きを学習した後、こちらの技術にも触れることができるようになっています。
...
"Python Arcade Library"は、サードパーティ製のライブラリです。
